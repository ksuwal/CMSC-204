...
public class Graph_STUDENT_Test {
	...
	public void setUp() throws Exception {
		 graph = new Graph();
		  ...
		  graph.addEdge(town[2], town[4], 3, "Road_3");
		  graph.addEdge(town[1], town[5], 2, "Road_4");
		  graph.addEdge(town[2], town[3], 1, "Road_5");
	}
	 ...
	 @Test
	  public void testTown_1ToTown_5() {
		  ...
		  if(beginIndex != null && endIndex != null)
		  {
			  ...
			  assertEquals("Town_1 via Road_4 to Town_5 2 mi",path.get(0).trim());
		  }
		  else
