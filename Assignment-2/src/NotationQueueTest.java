...
public class NotationQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(4.0, (Object)doubleQ.dequeue());
			assertEquals(5.0, (Object)doubleQ.dequeue());
			assertEquals(6.0, (Object)doubleQ.dequeue());
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertEquals("4.05.06.0", doubleQ.toString());
		doubleQ.enqueue(4.0);
		assertEquals("4.05.06.04.0", doubleQ.toString());
		doubleQ.enqueue(5.0);
		assertEquals("4.05.06.04.05.0", doubleQ.toString());
	}
